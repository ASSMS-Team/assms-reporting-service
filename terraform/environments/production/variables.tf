...
variable "platform_state_key" {
  ...
  type        = string
  default     = "platform/production.tfstate"
}
...
variable "vm_name" {
  ...
  type        = string
  default     = "vm-assms-reporting-production"
}
variable "vm_size" {
...
variable "nsg_name" {
  ...
  type        = string
  default     = "nsg-assms-reporting-production"
}
variable "nic_name" {
  description = "Name of the service NIC."
  type        = string
  default     = "nic-assms-reporting-production"
}
variable "public_ip_name" {
  description = "Name of the optional service public IP."
  type        = string
  default     = "pip-assms-reporting-production"
}
